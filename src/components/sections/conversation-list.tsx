      ...
      <div className="flex-1 overflow-y-auto">
        {conversations.map((conv) => (
          ...
          >
            ...
            >
              {editingId === conv.id ? (
                <input
                  ...
                  className="w-full rounded-lg border border-pink-200 bg-white px-2 py-0.5 text-sm text-gray-900 outline-none focus:border-pink-400"
                />
              ) : (
            ...
            <div className="mr-2 flex items-center gap-0.5 opacity-0 transition-all group-hover:opacity-100">
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  startRename(conv);
                }}
                className="rounded-lg p-1.5 text-gray-300 transition-all hover:bg-pink-50 hover:text-pink-500"
              >
